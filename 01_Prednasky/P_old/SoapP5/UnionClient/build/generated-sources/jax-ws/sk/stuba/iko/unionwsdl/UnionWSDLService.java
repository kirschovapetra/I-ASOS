 ...
 * 
 */
@WebServiceClient(name = "UnionWSDLService", targetNamespace = "http://iko.stuba.sk/UnionWSDL", wsdlLocation = "http://localhost:8080/UnionApp/UnionWSDLService?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/UnionApp/UnionWSDLService?WSDL");
